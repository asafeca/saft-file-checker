...
var CustomerValidation = /** @class */ (function () {
  ...
  CustomerValidation.isCustomerValid = function (_a) {
    ...
    if (!(customerNodeList.length - 1 <= 0)) {
      ...
      var result = this.checkCustomerChildren({
        customerNodeList: customerNodeList,
  ...
  CustomerValidation.checkCustomerChildren = function (_a) {
    var customerNodeList = _a.customerNodeList,
      customerAttributes = _a.customerAttributes;
  ...
  CustomerValidation.isAttributeInTheNode = function (_a) {
    var attribute = _a.attribute,
      customerNodeList = _a.customerNodeList;
    ...
    return new iresult_1.DataResult({
      message: 'Elemento inv\u00E1lido. ['.concat(attribute.getName(), '] n\u00E3o encontrado!'),
      success: false,
    });
  };
