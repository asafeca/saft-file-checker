      ...
      for (var _i = 0, _b = Object.keys(invoiceNodeList); _i < _b.length; _i++) {
        ...
        if (currentNode.nodeName !== '#text' && currentNode.nodeName !== undefined) {
          if (currentNode.nodeName === 'DocumentStatus' || currentNode.nodeName === 'SpecialRegimes') {
            ...
            var nodeResult = saft_validation_1.SaftValidation.verifyAttributesInTheNodes({
              ...
              if (currentShipNode.nodeName === 'Address') {
                ...
                if (!(shipAddressNodes.length - 1 <= 0)) {
                  ...
                  return new iresult_1.DataResult({
                    success: false,
                    message: 'Elemento '.concat(currentShipNode.nodeName, ' inv\u00E1lido'),
                  });
                }
              }
            }
            ...
            var totalsResult = document_totals_1.DocumentTotalsValidation.isDocumentTotalsValid({
              totalsNodes: totalsNodes,
            });
