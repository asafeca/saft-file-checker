...
var LineValidation = /** @class */ (function () {
  ...
  LineValidation.isLineValid = function (_a) {
    var lineNodes = _a.lineNodes,
      invoiceType = _a.invoiceType;
    var lineAttributeList =
      invoiceType.getName() == 'NC'
        ? saft_attributes_list_1.SaftAttributeList.NCLineAttributes
        : saft_attributes_list_1.SaftAttributeList.FTLineAttributes;
      ...
      if (currentNode.nodeName === 'Tax') {
        ...
        if (!(taxNodes.length - 1 <= 0)) {
          ...
          return new iresult_1.DataResult({
            message: 'Elemento ['.concat(currentNode.nodeName, '] n\u00E3o v\u00E1lido!'),
            success: false,
          });
        }
      }
