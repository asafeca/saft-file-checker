...
export class SaftAttributeList {
  static CompanyAddressAttributes = [
  ...
  static BillingAndShipToAddressAttributes = [
    new SaftAttributeModel({ name: 'AddressDetail', type: 'string', isParent: false }),
    new SaftAttributeModel({ name: 'City', type: 'string', isParent: false }),
    new SaftAttributeModel({ name: 'PostalCode', type: 'string', isParent: false }),
    new SaftAttributeModel({ name: 'Province', type: 'string', isParent: false }),
  ...
  static TaxTableEntryAttributes = [
  ...
  static SourceDocumentsAttributes = [
  ...
  static SalesInvoicesAttributes = [
  ...
  static DocumentTotalsSimpleAttributes = [
  ...
  static DocumentTotalsWithCurrencyAttributes = [
  ...
  static SpecialRegimesAttributes = [
  ...
  static ShipToAndShiFromAttributes = [
  ...
  static ShipToAndShipFromAddressAttributes = [
    new SaftAttributeModel({ name: 'AddressDetail', type: 'string', isParent: false }),
    new SaftAttributeModel({ name: 'City', type: 'string', isParent: false }),
    new SaftAttributeModel({ name: 'PostalCode', type: 'string', isParent: false }),
    new SaftAttributeModel({ name: 'Country', type: 'string', isParent: false }),
  ...
  static DocumentStatusAttributes = [
  ...
  static WorkingDocumentsAttributes = [
    new SaftAttributeModel({ name: 'NumberOfEntries', type: 'int', isParent: false }),
    new SaftAttributeModel({ name: 'TotalDebit', type: 'decimal', isParent: false }),
    new SaftAttributeModel({ name: 'TotalCredit', type: 'decimal', isParent: false }),
  ...
  static WorkDocumentAttributes = [
    new SaftAttributeModel({ name: 'DocumentNumber', type: 'string', isParent: false }),
  ...
  static WorkDocDocumentStatusAttributes = [
